...
| ---------------------- | ---------------- | ---------------- | --------------------- |
| `check_palindrome_1`   |4.68 msec per loop|3.69 msec per loop|56.6 msec per loop     |
| `check_palindrome_2`   |3.41 msec per loop|2.88 msec per loop|2.97 msec per loop     | 
